...
namespace Exambuddy2.Module.Migrations
{
    ...
    [Migration("20201219183131_more2")]
    partial class more2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.RelatedFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.Topic", b =>
                {
                    ...
                    b.Property<int?>("CourseUnitId1")
                        .HasColumnType("int");

                    b.Property<int?>("CourseUnitId2")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CourseUnitId1");

                    b.HasIndex("CourseUnitId2");
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.Question", b =>
                {
                    ...
                    b.HasOne("Exambuddy2.Module.BusinessObjects.Topic", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.RelatedFile", b =>
                {
                    b.HasOne("DevExpress.Persistent.BaseImpl.EF.FileData", "DataFile")
                        .WithMany()
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.Topic", b =>
                {
                    ...
                    b.HasOne("Exambuddy2.Module.BusinessObjects.CourseUnit", null)
                        .WithMany()
                        .HasForeignKey("CourseUnitId1");

                    b.HasOne("Exambuddy2.Module.BusinessObjects.CourseUnit", null)
                        .WithMany()
                        .HasForeignKey("CourseUnitId2");
