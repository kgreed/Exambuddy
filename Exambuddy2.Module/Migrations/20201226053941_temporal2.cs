...
{
    public partial class temporal2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            
            AddTemporalTableSupport(migrationBuilder, "FileDataSources", "History");
            AddTemporalTableSupport(migrationBuilder, "FileDataQuestions", "History");
            AddTemporalTableSupport(migrationBuilder, "FileDataAnswers", "History");
        }
