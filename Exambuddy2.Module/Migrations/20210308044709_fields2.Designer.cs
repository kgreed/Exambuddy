...
namespace Exambuddy2.Module.Migrations
{
    ...
    [Migration("20210308044709_fields2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.AnswerCommentCategpry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.Card", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.CardFileData", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.AnswerComment", b =>
                {
                    ...
                    b.HasOne("Exambuddy2.Module.BusinessObjects.AnswerCommentCategpry", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Exambuddy2.Module.BusinessObjects.Card", b =>
                {
                    b.HasOne("Exambuddy2.Module.BusinessObjects.CardFileData", "DataFile")
                        .WithMany()
                        .HasForeignKey("FileId");

                    b.HasOne("Exambuddy2.Module.BusinessObjects.Card", "ParentCard")
                        .WithMany()
